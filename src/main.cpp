...
uint256 hashGenesisBlock("0xde4d1ab8619a64bbca77c94e7d24a3346e23c87a4233db5ee6ac78a4346ee331");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // xenzacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "xenzacoin Signed Message:\n";
...
{
    // xenzacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // xenzacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // xenzacoin: 3.5 days
static const int64 nTargetSpacing = 150; // xenzacoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // xenzacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // xenzacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // xenzacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x62237a8eaed9e2e53835f090500f847486698610ec35c30a07a31feca07ffc1a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("2c9054269a88e3117df8106c26f08499ec454e643992c08fa30101eb8397f1b5b780cd60cd6b162177adea1d08f5205fd4a08e0ce384db3cee9feec885c51e8b1c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1509784799;
        block.nBits    = 504365644;
        block.nNonce   = 1675871905;

        if (fTestNet)
        {
            block.nTime    = 1509784799;
            block.nNonce   = 2742794237;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xebf70f15715573eacaacccf8579fa4ae8c76a7ce433f6bee65dca98e5af5f3ea"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // xenzacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("xenzacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("xenzacoinMiner : ProcessBlock, block not accepted");
    }
